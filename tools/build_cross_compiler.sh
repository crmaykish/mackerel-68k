...
cd Baselibc
make PLATFORM=m68k-mackerel-elf
cp -r include/ "${PREFIX}/m68k-mackerel-elf/"
cp libc.a "${PREFIX}/m68k-mackerel-elf/lib/"
...
log_message "Done! Add ${PREFIX}/bin to your PATH to use the m68k-mackerel-elf- tools."
